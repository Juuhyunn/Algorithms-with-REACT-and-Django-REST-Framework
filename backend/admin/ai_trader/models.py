...
class AiTrader(object):
    ...
    #         tf.keras.layers.Dropout(rate=0.2),    # 오버피팅을 막기위한 드롭아웃, 사용되었던(학습된) 뉴런 중 20퍼센트를 삭제한다. 결과가 100%나오지 않도록. 가우스 정규분포 모양을 만들려고.
...
class Trading:
    ...
    def state_creator(self, data, timestamp, window_size):
