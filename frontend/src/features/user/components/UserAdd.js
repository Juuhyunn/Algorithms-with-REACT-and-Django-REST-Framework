...
export function UserAdd() {
    ...
    const userJoin = joinRequest => 
                axios.post(`${SERVER}/api/users/list`, JSON.stringify(joinRequest),{headers})
    const headers = {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} method='POST'>
            <ul>
                ...
                <li>
                    <label>
                        이메일 : <input type="text" id="email" name="email" value={email} onChange={handleChange}/>
                    </label>
                </li>
                <li>
                    <label>
                        비밀 번호 : <input type="text" id="password" name="password" value={password} onChange={handleChange}/>
                    </label>
                </li>
                <li>
                    <label>
